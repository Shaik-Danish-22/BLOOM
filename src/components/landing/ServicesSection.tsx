  ...
  return (
    <section className="bg-black py-28 md:py-40 px-6 overflow-hidden relative">
      ...
      <div className="max-w-6xl mx-auto space-y-16 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-5xl text-white tracking-tight font-display">What we do</h2>
          <span className="text-white/40 text-sm hidden md:block uppercase tracking-widest font-bold">Our services</span>
        </motion.div>
            ...
            >
              ...
              <div className="p-6 md:p-8 space-y-4">
                <div className="flex justify-between items-center">
                  <span className="uppercase tracking-widest text-white/40 text-xs font-bold">{service.tag}</span>
                  <div className="liquid-glass rounded-full p-2">
                    <ArrowUpRight size={18} className="text-white" />
                  </div>
                </div>
                <div>
                  <h3 className="text-white text-xl md:text-2xl mb-3 tracking-tight font-display">{service.title}</h3>
