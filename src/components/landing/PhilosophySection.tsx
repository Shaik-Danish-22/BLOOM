  ...
  return (
    <section className="bg-black py-28 md:py-40 px-6 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        >
          Innovation <span className="font-serif italic text-white/40">then x</span> Vision
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          >
            <div className="space-y-4">
              <span className="text-white/40 text-xs tracking-widest uppercase block font-bold">Choose your space</span>
            ...
            <div className="space-y-4">
              <span className="text-white/40 text-xs tracking-widest uppercase block font-bold">Shape the future</span>
              <p className="text-white/70 text-base md:text-lg leading-relaxed">
