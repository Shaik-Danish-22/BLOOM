...
/**
 * @fileOverview Neural Plasma Shader: High-density WebGL background for Bloom Auth Nodes.
 * Orchestrates immersive visual DNA with plasma-based line behavior.
 */
...
const ShaderBackground = () => {
  ...
  const fsSource = `
    ...
    void main() {
      ...
      vec4 finalColor = mix(bgColor1, bgColor2, uv.x);
