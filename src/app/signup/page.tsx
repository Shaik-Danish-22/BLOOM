  ...
  return (
    <div className="relative min-h-screen bg-black overflow-hidden flex flex-col selection:bg-[#DCFF00]/30 font-body text-white">
      ...
      <nav className="relative z-50 px-12 py-10 flex justify-between items-center">
        ...
        <button onClick={() => router.push('/login')} className="text-white/40 hover:text-white text-[11px] font-bold uppercase tracking-[0.5em] transition-all font-body">
          ...
          >
            <div className="aspect-[4/5] relative w-full overflow-hidden rounded-[5rem] bg-white/[0.03] border border-white/10 backdrop-blur-3xl group shadow-[0_50px_100px_rgba(0,0,0,0.7)]">
               ...
               <motion.div 
                 ...
                 className="absolute bottom-16 left-16 z-30 w-full max-w-[320px]"
               >
          ...
          >
            ...
            <div className="pt-6 flex flex-col space-y-10">
              ...
              <div className="text-center font-body">
                <p className="text-[11px] text-white/30 uppercase tracking-[0.8em] leading-relaxed italic font-bold max-w-md mx-auto">
